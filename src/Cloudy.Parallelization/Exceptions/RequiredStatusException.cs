namespace Cloudy.Parallelization.Exceptions;

/// <summary>
/// Exception that is thrown when a method of a <see cref="ParallelizerStatus"/> can only
/// be executed when its status has one of the specified <see cref="Parallelizer{TInput,TOutput}"/> values.
/// </summary>
